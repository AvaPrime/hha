-- =============================================================================
-- Codessa Health Schema Pack v1.0 (migration)
...
DO $$ BEGIN
  ALTER TYPE anomaly_type ADD VALUE IF NOT EXISTS 'effective_path_low_capacity';
  ALTER TYPE anomaly_type ADD VALUE IF NOT EXISTS 'configured_vs_effective_path_mismatch';
  ALTER TYPE anomaly_type ADD VALUE IF NOT EXISTS 'env_override_shadowing';
  ALTER TYPE anomaly_type ADD VALUE IF NOT EXISTS 'disk_exhaustion_effective_path';
  ALTER TYPE anomaly_type ADD VALUE IF NOT EXISTS 'tool_cache_reserved_partition';
  ALTER TYPE anomaly_type ADD VALUE IF NOT EXISTS 'cache_temp_exhausted_colocation';
  ALTER TYPE anomaly_type ADD VALUE IF NOT EXISTS 'high_growth_cache_low_verification_success';
...
DO $$ BEGIN
  ALTER TYPE workload_class ADD VALUE IF NOT EXISTS 'local_build';
  ALTER TYPE workload_class ADD VALUE IF NOT EXISTS 'dependency_install';
  ALTER TYPE workload_class ADD VALUE IF NOT EXISTS 'workspace_repair';
EXCEPTION WHEN undefined_object THEN NULL; END $$;
...
DO $$ BEGIN
  ALTER TYPE adapter_type ADD VALUE IF NOT EXISTS 'path_probe';
  ALTER TYPE adapter_type ADD VALUE IF NOT EXISTS 'resource_probe';
  ALTER TYPE adapter_type ADD VALUE IF NOT EXISTS 'toolchain_resolver';
  ALTER TYPE adapter_type ADD VALUE IF NOT EXISTS 'env_probe';
  ALTER TYPE adapter_type ADD VALUE IF NOT EXISTS 'filesystem_probe';
  ALTER TYPE adapter_type ADD VALUE IF NOT EXISTS 'temp_probe';
EXCEPTION WHEN undefined_object THEN NULL; END $$;
...
DO $$ BEGIN
  ALTER TABLE hardware_incidents
    ADD COLUMN IF NOT EXISTS primary_diagnosis_id UUID;
  ALTER TABLE hardware_incidents
    ADD COLUMN IF NOT EXISTS verification_result_id UUID;
  ALTER TABLE hardware_incidents
    ADD COLUMN IF NOT EXISTS remediation_plan_ids UUID[] NOT NULL DEFAULT '{}';
EXCEPTION WHEN undefined_table THEN NULL; END $$;
...
VALUES
  ...
  ('1.0.0', 'Unified Codessa Health Schema Pack with Health Adapter CMOs')
